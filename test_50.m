% clear 
%close all
data_files=dir('D:\孟純\mandywu\睡眠判讀\data\睡眠中心(大郭舊data)\MAT\*.mat');
stage_files=dir('D:\孟純\mandywu\睡眠判讀\data\睡眠中心(大郭舊data)\Stage_dat\*.dat');
feat_files=dir('D:\孟純\mandywu\睡眠判讀\data\睡眠中心(大郭舊data)\MAT\feat_chun\*.mat');
feat_files2=dir('D:\孟純\mandywu\睡眠判讀\data\睡眠中心(大郭舊data)\MAT\feat_o\*.mat');
% %%
...
% save(['D:\孟純\mandywu\睡眠判讀\data\睡眠中心(大郭舊data)\MAT\feat_chun\' data_files(data_num).name(1:end-4) '_feat.mat'],'feat');
[autostage_chun nodestage] = run_purposed_chun(data',feat);
save(['D:\孟純\mandywu\睡眠判讀\data\睡眠中心(大郭舊data)\MAT\autostage_chun\' data_files(data_num).name(1:end-4) '_autostage.mat'],'autostage_chun');
agreement_chun(data_num)=length(find(autostage_chun==stage))/length(stage);
[autostage nodestage] = run_purposed(data',feat);
save(['D:\孟純\mandywu\睡眠判讀\data\睡眠中心(大郭舊data)\MAT\autostage_o\' data_files(data_num).name(1:end-4) '_autostage.mat'],'autostage');
