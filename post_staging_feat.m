...
%              end
            ...
            if auto_staging_ini(epoch_no-2) == 1 & auto_staging_ini(epoch_no-1) == 4 & auto_staging_ini(epoch_no) == 4 & auto_staging_ini(epoch_no+1) == 2
                tmp = [epoch_no-1 epoch_no];
                if feat(tmp,21) >0.15 
                    auto_staging_ini(tmp) = 1;  %  n1,REM,REM,n2 --> n1,n1,n1,n2
                end
            end
            if auto_staging_ini(epoch_no-1) == 4 & auto_staging_ini(epoch_no-2) == 1 & auto_staging_ini(epoch_no) == 2
                if feat(epoch_no-1,21) >0.15 
...
%                 end
            ...
            if epoch_no>10
%                 if auto_staging_ini(epoch_no-10) == 4 & auto_staging_ini(epoch_no-9) == 4 & auto_staging_ini(epoch_no) == 4 & auto_staging_ini(epoch_no+1) == 4 
...
%                         auto_staging_ini(tmp1) = 4 ;  %  REM,X,REM --> REM,REM,REM
%                     end
%                 end
%                 if auto_staging_ini(epoch_no-9) == 4 & auto_staging_ini(epoch_no-8) == 4 & auto_staging_ini(epoch_no) == 4 & auto_staging_ini(epoch_no+1) == 4 
%                     tmp1 = [epoch_no-7 epoch_no-6 epoch_no-5 epoch_no-4 epoch_no-3 epoch_no-2 epoch_no-1];
%                      if feat(tmp1,15) < 0.6 | feat(tmp1,19) < 0.1 | feat(tmp1,21) < 0.3 |feat(tmp1,22) < 0.4 |feat(tmp1,25) < 0.1 |feat(tmp1,27) < 0.1 | feat(tmp1,43) < 0.1 |feat(tmp1,45) < 0.2 | feat(tmp1,47) < 0.1 | feat(tmp1,49) < 0.1 %feat(tmp1,4) > 0.2  %remove real N2
%                         auto_staging_ini(tmp1) = 4 ;  %  REM,X,REM --> REM,REM,REM
%                     end
%                 end
%                 if auto_staging_ini(epoch_no-8) == 4 & auto_staging_ini(epoch_no-7) == 4 & auto_staging_ini(epoch_no) == 4 & auto_staging_ini(epoch_no+1) == 4 
%                     tmp1 = [epoch_no-6 epoch_no-5 epoch_no-4 epoch_no-3 epoch_no-2 epoch_no-1];
%                     if feat(tmp1,15) < 0.6 | feat(tmp1,19) < 0.1 | feat(tmp1,21) < 0.3 |feat(tmp1,22) < 0.4 |feat(tmp1,25) < 0.1 |feat(tmp1,27) < 0.1 | feat(tmp1,43) < 0.1 |feat(tmp1,45) < 0.2 | feat(tmp1,47) < 0.1 | feat(tmp1,49) < 0.1 %feat(tmp1,4) > 0.2  %remove real N2
%                         auto_staging_ini(tmp1) = 4 ;  %  REM,X,REM --> REM,REM,REM
%                     end
%                 end
                if auto_staging_ini(epoch_no-2) == 4 & auto_staging_ini(epoch_no+3) == 4 
                    tmp1 = [epoch_no-1 epoch_no epoch_no+1 epoch_no+2];
                    if feat(tmp1,15) < 0.6 | feat(tmp1,19) < 0.1 | feat(tmp1,21) < 0.3 |feat(tmp1,22) < 0.4 |feat(tmp1,25) < 0.1 |feat(tmp1,27) < 0.1 | feat(tmp1,43) < 0.1 |feat(tmp1,45) < 0.2 | feat(tmp1,47) < 0.1 | feat(tmp1,49) < 0.1 %feat(tmp1,4) > 0.2  %remove real N2
                        auto_staging_ini(tmp1) = 4 ;  %  REM,X,REM --> REM,REM,REM
                    end
                end
                if auto_staging_ini(epoch_no-2) == 4 & auto_staging_ini(epoch_no+2) == 4 
                    ...
                    if feat(tmp2,15) < 0.6 | feat(tmp2,19) < 0.1 | feat(tmp2,21) < 0.3 |feat(tmp2,22) < 0.4 |feat(tmp2,25) < 0.1 |feat(tmp2,27) < 0.1 | feat(tmp2,43) < 0.1 |feat(tmp2,45) < 0.2 | feat(tmp2,47) < 0.1 | feat(tmp2,49) < 0.1 %feat(tmp1,4) > 0.2  %remove real N2
                        auto_staging_ini(tmp2) = 4 ;  %  REM,X,REM --> REM,REM,REM
                    end
                end
                if auto_staging_ini(epoch_no-2) == 4 & auto_staging_ini(epoch_no+1) == 4 
                    ...
                    if feat(tmp3,15) < 0.6 | feat(tmp3,19) < 0.1 | feat(tmp3,21) < 0.3 |feat(tmp3,22) < 0.4 |feat(tmp3,25) < 0.1 |feat(tmp3,27) < 0.1 | feat(tmp3,43) < 0.1 |feat(tmp3,45) < 0.2 | feat(tmp3,47) < 0.1 | feat(tmp3,49) < 0.1 %feat(tmp1,4) > 0.2  %remove real N2
                        auto_staging_ini(tmp3) = 4 ;  %  REM,X,REM --> REM,REM,REM
                    end
                end
            end
            if (auto_staging_ini(epoch_no-1) == 2 || auto_staging_ini(epoch_no-1) == 1 )&& auto_staging_ini(epoch_no) == 4 && (auto_staging_ini(epoch_no+1) == 2 || auto_staging_ini(epoch_no+1) == 1)
                    auto_staging_ini(epoch_no) = auto_staging_ini(epoch_no-1);  %  N1,REM,N1 --> N1,N1,N1
            ...
            if auto_staging_ini(epoch_no-1) == 4 & auto_staging_ini(epoch_no) == 2 & auto_staging_ini(epoch_no-2) == 2
            ...
            %else
            if auto_staging_ini(epoch_no-1) == 4 & auto_staging_ini(epoch_no-2) == 1 & auto_staging_ini(epoch_no) == 0
                auto_staging_ini(epoch_no-1) = 0;  %  n1,REM,W --> n1,W,W
            end
            if auto_staging_ini(epoch_no-1) == 4 & auto_staging_ini(epoch_no-2) == 2 & auto_staging_ini(epoch_no) == 1
                auto_staging_ini(epoch_no-1) = 1;  %  n2,REM,n1 --> n2,n1,n1
            end
            if auto_staging_ini(epoch_no-1) == 4 & auto_staging_ini(epoch_no-2) == -2 & auto_staging_ini(epoch_no) == 2
...
%     for epoch_no = 60:length(auto_staging_ini)-6
%         if auto_staging_ini(epoch_no) == 4 
%             epoch_no
%             tmpR=[epoch_no-2:epoch_no+2];
%             if length(find(auto_staging_ini(tmpR) == 4 )) >= 3 && find(auto_staging_ini(tmpR) == 4 )~=5 
%                 auto_staging_ini(tmpR) = 4 
%             end
%             
%         end
%     end
